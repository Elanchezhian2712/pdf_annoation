...
def add_annotation(request):
    ...
    try:
        ...
        orig_width = page_info['orig_width']
        orig_height = page_info['orig_height']

        # Convert image coordinates (relative to rendered image) to PDF coordinates
        # Assumes image origin top-left, PDF origin top-left (PyMuPDF default)
        pdf_x = img_x / scale
        pdf_y = img_y / scale
        ...
        # --- Recalculate Counts ---
        _, counts = get_session_data(request) # Use helper to get updated counts
